...
import { Trash2, Edit2, X, Bell } from 'lucide-react'
  ...
  return (
    <div style={{ background: '#f5f7fa', minHeight: '100vh' }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.15)', borderRadius: 14, padding: '16px 20px', backdropFilter: 'blur(10px)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1px 1fr', gap: 0 }}>
            <div style={{ textAlign: 'center' }}>
              ...
              {summary.income.TWD === 0 && summary.income.MYR === 0 && <p style={{ color: 'rgba(255,255,255,0.5)', fontWeight: 700, fontSize: 17 }}>--</p>}
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              {summary.expense.TWD === 0 && summary.expense.MYR === 0 && <p style={{ color: 'rgba(255,255,255,0.5)', fontWeight: 700, fontSize: 17 }}>--</p>}
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: '16px', paddingBottom: 90, marginTop: -4 }}>
        <h2 style={{ fontSize: 16, fontWeight: 700, color: '#2c2e2f', marginBottom: 12 }}>最近記錄</h2>
